        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="contact-wrap">
                    ...
                    <form action="{{ URL::to('/submitOtp2').'/'.request()->route()->parameters['candidate_voter_card'] }}" method="POST" class="contact-inner-page">
                        {{ csrf_field() }} 
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <!-- <div class="@if(!$errors->has('otp')) d-none @endif resend-btn"> -->
                        ...
                        <form action="{{ URL::to('/resendOtp2') }}" method="post">
                            {{ csrf_field() }} 
